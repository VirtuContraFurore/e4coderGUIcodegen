 ...
 * </p>
 * <ul>
 *   <li>{@link it.sssuprojects.e4codergui.impl.PointImpl#getX <em>X</em>}</li>
 *   <li>{@link it.sssuprojects.e4codergui.impl.PointImpl#getY <em>Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointImpl extends MinimalEObjectImpl.Container implements Point {
	...
	protected EClass eStaticClass() {
		return E4coderguiPackage.Literals.POINT;
	}
	...
	public void setX(BigInteger newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E4coderguiPackage.POINT__X, oldX, x));
	}
	...
	public void setY(BigInteger newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E4coderguiPackage.POINT__Y, oldY, y));
	}
