...
/**
 * This is the item provider adapter for a {@link it.sssuprojects.e4codergui.Point} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 E4coderguiPackage.Literals.POINT__X,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 E4coderguiPackage.Literals.POINT__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		BigInteger labelValue = ((Point)object).getX();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Point.class)) {
			case E4coderguiPackage.POINT__X:
			case E4coderguiPackage.POINT__Y:
